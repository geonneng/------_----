...
export const joseonScenarios: Record<string, Scenario> = {
  'joseon-act1': {
    ...
    content: [
      ...
      { text: '\'올 것이 왔구나.\'\n벼락이 머리를 내리치는 듯했다. 빗속에서 고뇌하던 아버님의 얼굴이 떠올랐다. 무리한 요동 정벌. 끝내 결심하셨다.\n\'역적\'이 되시거나, \'왕\'이 되시거나.\n역사의 수레바퀴가... 지금, 거대하게 구르기 시작했다.', isThought: true }
    ],
    choices: [
  ...
  'joseon-act4': {
    ...
    content: [
      { text: '새 왕이 섰지만, 낡은 귀족(권문세족)들은 여전히 거대한 토지를 쥐고 부(富)를 독점하고 있었다. 이들의 돈줄을 끊지 않으면, 새 나라는 빈 껍데기에 불과했다.' },
      { speaker: '정도전', text: '(어전 회의에서 목소리를 높인다) "전하! 썩은 귀족들의 토지를 몰수하여, 새 관리들에게 나누어 주어야(과전법) 나라가 바로 섭니다!"' },
      { speaker: '정몽주', text: '(차가운 목소리로 반박한다) "삼봉! 그대의 개혁은 핑계일 뿐, 고려의 근본을 무너뜨리려는 속셈이 아니오!"' },
      { text: '\'정도전 숙부의 말이 맞다. 저들의 토지를 빼앗아야 새 나라의 기틀을 잡을 수 있다. 하지만... 정몽주 선생의 반대가 너무나도 거세다. 아버님조차 저 충신의 눈치를 보고 계신다.\'', isThought: true }
    ],
    choices: [
  ...
  'joseon-act5-intro': {
    ...
    content: [
      ...
      { speaker: '하인', text: '(다급하게) "도련님! 정몽주 대감이 상소를 올려, 정도전 대감과 우리 편을 모두 쫓아냈습니다! 이제 칼끝이 우리를 향할 것입니다!"' },
...
export const goryeoScenarios: Record<string, Scenario> = {
  ...
  'goryeo-act4': {
    ...
    image: '/image/고려 및 조선 편 4막.png',
    content: [
      { text: '공양왕이 왕위에 올랐지만, 세상은 여전히 혼란했다. 이성계파는 썩은 귀족들의 토지를 빼앗아 나누어주자고(과전법) 주장했다.' },
      { speaker: '정도전', text: '"대감! 낡은 밭을 갈지 않고 어찌 새 곡식을 얻겠습니까!"' },
      { text: '\'...그의 말은 옳다. 고려는 썩었다. 개혁은 필요하다.\'\n나도 오랫동안 그리 생각해왔다.\n\'하지만... 나는 안다. 저들의 목적은 \'개혁\'이 아니라, 고려의 마지막 숨통을 끊고 \'새 나라\'를 여는 것임을. 저들의 손에 고려의 토지 문서를 넘길 수는 없다.\'', isThought: true }
    ],
    choices: [
...
export const scenarioResults: Record<string, ScenarioResult> = {
  ...
  'j1-a': {
    ...
    content: [
      ...
      { speaker: '척후병', text: '"도련님! 최영 장군이 군사를 모아 4대문을 모두 걸어 잠갔습니다! 개경은 완전히 봉쇄되었습니다!"' },
  ...
  'j2-a': {
    id: 'j2-a',
    content: [
      { text: '우리의 최후통첩에 최영 장군은 "역적과는 대화하지 않는다!"라며 사신을 내쫓았다. 협상은 결렬되었다. 하지만 우리는 공격의 명분을 얻었다.' }
    ],
  ...
  'j2-b': {
    id: 'j2-b',
    content: [
      { text: '"전군, 불화살을 발사하라!"\n나의 명령에 수백 개의 불화살이 밤하늘을 가르며 궁궐을 향해 날아갔다.\n"역적 놈들!" 최영의 군대가 반격해오기 시작했다. 개경 시내가 불바다로 변했다.' }
    ],
    nextScreen: 'battle'
  },
  'j2-c': {
  ...
  'j3-a': {
    id: 'j3-a',
    content: [
      { text: '"폐가입진(廢假立眞)".\n우리는 \'가짜를 폐하고 진짜를 세운다\'는 명분으로 창왕을 몰아내고, 유약한 공양왕을 왕위에 앉혔다. 고려의 왕권은 완전히 땅에 떨어졌고, 모든 실권은 아버님과 우리에게 넘어왔다.' }
    ],
  ...
  'j4-a': {
    id: 'j4-a',
    content: [
      { text: '나는 정몽주 선생을 찾아가 몇 날 며칠을 설득했다.' },
      { speaker: '이방원', text: '"선생님, 백성을 위한 길입니다."' },
      { speaker: '정몽주', text: '"백성을 위한다면 고려의 법도 안에서 하시오. 나라의 근간을 흔들지는 마시오."' },
      { text: '\'그는 나의 진심에 감동한 듯했으나, 끝내 "고려의 신하로서 할 수 없는 일이 있소."라며 고개를 저었다. 우리의 개혁은 지연되었다.\'', isThought: true }
    ],
  ...
  'j4-b': {
    id: 'j4-b',
    content: [
      { text: '아버님은 나의 강경한 주장에 마침내 결단을 내렸다. 정몽주를 따르던 늙은 신하들이 쫓겨나고, 개경 한복판에서 낡은 토지 문서들이 불태워졌다.' },
      { text: '\'우리는 새 나라의 기반을 닦았지만, 정몽주라는 무서운 적을 만들었다. 그는 불타는 문서를 보며 나를 돌아보았다. 그 눈빛을 잊을 수 없다.\'', isThought: true }
    ],
    nextScenarioId: 'joseon-act5-intro'
  },
  'j4-c': {
  ...
  'g1-a': {
    id: 'g1-a',
    content: [
      { text: '나의 전갈을 받은 최영 장군이 즉시 군사를 모으고, 이성계의 가족들을 잡아들였다. 이성계는 분노했지만, 우리는 수도를 지킬 준비를 마칠 수 있었다.' },
  ...
  'g1-c': {
    id: 'g1-c',
    content: [
      { text: '우리가 왕을 모시고 피난길에 오르자, 개경은 혼란에 빠졌다. 백성들은 "왕이 우리를 버렸다!"며 절규했고, 이성계는 저항 없이 성문을 열었다.' },
  ...
  'g3-a': {
    id: 'g3-a',
    content: [
      { text: '나는 창왕을 지키려 했으나, 이성계의 군사력 앞에 무릎 꿇었다. 창왕은 폐위되었고, 나는 \'가짜 왕을 옹호한 자\'로 몰려 잠시 권력에서 밀려나고 말았다.' }
    ],
  ...
  'g3-b': {
    id: 'g3-b',
    content: [
      { text: '나 또한 그들의 \'폐가입진\'에 동의했다. 우리는 함께 공양왕을 새 왕으로 세웠다. 비록 이성계파와 손을 잡았지만, 고려를 개혁할 수 있는 힘을 얻었다고 생각했다.' }
    ],
    nextScenarioId: 'goryeo-act4'
  },
  'g3-c': {
  ...
  'g4-a': {
    id: 'g4-a',
    content: [
      { text: '나의 격렬한 반대에 부딪힌 이성계파는 토지 개혁을 미룰 수밖에 없었다. 나는 고려를 지킬 시간을 벌었지만, 그들은 나를 \'제거해야 할 적\'으로 분명히 인식하기 시작했다.' }
    ],
  ...
  'g4-b': {
    id: 'g4-b',
    content: [
      { text: '나는 정도전과 치열한 토론을 벌이며 개혁을 주도하려 애썼다. 그 과정에서 일부 성과를 거두었지만, 결국 그들의 힘에 밀려 개혁의 방향은 그들이 원하는 대로 흘러가고 말았다.' }
    ],
    nextScenarioId: 'goryeo-act5-intro'
  },
  'g4-c': {
    id: 'g4-c',
    content: [
      { text: '나는 백성들을 구제하는 정책을 펼쳐 큰 지지를 얻었다. 나의 명망이 높아지는 것을 본 이성계파는 나를 함부로 대하지 못했다. 하지만 정작 중요한 토지 개혁의 주도권은 그들에게 넘어가고 말았다.' }
    ],
    nextScenarioId: 'goryeo-act5-intro'
  },
